...
class ErrorHandler:
    ...
    def handle_parsing_error(
        self, error: Exception, context: Dict[str, Any], reraise: bool = True
        ...
        self.logger.error(
            f"Parsing error: {error}", extra={"extra_fields": error_info}, exc_info=True
        )
...
def create_context_logger(
    base_logger: logging.Logger, context: Dict[str, Any]
